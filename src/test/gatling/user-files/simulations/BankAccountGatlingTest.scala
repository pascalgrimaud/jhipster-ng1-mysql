...
class BankAccountGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the BankAccount entity")
        ...
        .repeat(2) {
            ...
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "name":"SAMPLE_TEXT", "bankNumber":"0", "agencyNumber":null, "lastOperationDuration":null, "meanOperationDuration":null, "balance":"0", "openingDay":"2020-01-01T00:00:00.000Z", "lastOperationDate":"2020-01-01T00:00:00.000Z", "active":null, "accountType":null, "attachment":null, "description":null}""")).asJSON
            .check(status.is(201))
