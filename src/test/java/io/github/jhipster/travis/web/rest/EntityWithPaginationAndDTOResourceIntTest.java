...
public class EntityWithPaginationAndDTOResourceIntTest {
    ...
    public void setup() {
        ...
        EntityWithPaginationAndDTOResource entityWithPaginationAndDTOResource = new EntityWithPaginationAndDTOResource(entityWithPaginationAndDTORepository, entityWithPaginationAndDTOMapper);
