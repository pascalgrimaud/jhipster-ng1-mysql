...
describe('Controller Tests', function() {
    ...
    describe('TestManyToOne Management Detail Controller', function() {
        var $scope, $rootScope;
        var MockEntity, MockPreviousState, MockTestManyToOne, MockTestEntity, MockTestMapstruct, MockTestServiceClass, MockTestServiceImpl, MockTestInfiniteScroll, MockTestPager, MockTestPagination, MockTestCustomTableName;
        ...
        beforeEach(inject(function($injector) {
            ...
            createController = function() {
                $injector.get('$controller')("TestManyToOneDetailController", locals);
            };
        }));
        ...
        describe('Root Scope Listening', function() {
            it('Unregisters root scope listener upon scope destruction', function() {
                var eventType = 'travisMysqlApp:testManyToOneUpdate';
