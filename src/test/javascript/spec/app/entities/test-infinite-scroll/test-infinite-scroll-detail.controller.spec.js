...
describe('Controller Tests', function() {
    ...
    describe('TestInfiniteScroll Management Detail Controller', function() {
        var $scope, $rootScope;
        var MockEntity, MockPreviousState, MockTestInfiniteScroll, MockTestManyToOne, MockTestManyToMany, MockTestOneToOne, MockUser;
        ...
        beforeEach(inject(function($injector) {
            ...
            createController = function() {
                $injector.get('$controller')("TestInfiniteScrollDetailController", locals);
            };
        }));
        ...
        describe('Root Scope Listening', function() {
            it('Unregisters root scope listener upon scope destruction', function() {
                var eventType = 'travisMysqlApp:testInfiniteScrollUpdate';
